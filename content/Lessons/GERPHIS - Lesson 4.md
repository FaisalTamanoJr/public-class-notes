...
1. The Philippines Under Spain (Lecture Slides)
...
1. **Alcadia:** This type was led by the ==alcalde mayor== and focused on ==fully subjugated provinces==.
2. **Corregimiento:** This type was led by the ==corregidor== and was responsible for ==provinces that were not completely under Spanish control==.
...
1. Workers should be paid for their services.
2. They should not be assigned to places that they could not return home.
3. Drafting should occur at the same time as harvest season.
4. Physically incapable workers are forbidden from being forced to overwork.
5. Only force label when it is absolutely necessary.
6. Use Chinese laborers instead of Filipino ones when available.
